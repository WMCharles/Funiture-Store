  ...
  return (
    <div className="filter">
      <div className="category-buttons">
        ...
        <p onClick={() => filterProducts("Dining")}>Dining Room</p>
      ...
      <div className="filter-container">
        <div className="wrap">
          <div className="search">
            <input type="text" className="searchTerm" placeholder="What product are you looking for?" onChange={(e) => input(e.target.value.toLocaleUpperCase())}/>
